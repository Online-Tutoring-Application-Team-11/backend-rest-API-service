...
public class AppointmentsRecord extends TableRecordImpl<AppointmentsRecord> implements Record5<Integer, Integer, OffsetDateTime, OffsetDateTime, String> {
     ...
     */
    public AppointmentsRecord setStartTime(OffsetDateTime value) {
        set(2, value);
        return this;
    }
     ...
     */
    public AppointmentsRecord setEndTime(OffsetDateTime value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row5<Integer, Integer, OffsetDateTime, OffsetDateTime, String> valuesRow() {
    ...
    @Override
    public AppointmentsRecord value3(OffsetDateTime value) {
        setStartTime(value);
        return this;
    }

    @Override
    public AppointmentsRecord value4(OffsetDateTime value) {
        setEndTime(value);
        return this;
    }
    ...
    @Override
    public AppointmentsRecord values(Integer value1, Integer value2, OffsetDateTime value3, OffsetDateTime value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppointmentsRecord(Integer tutorId, Integer studentId, OffsetDateTime startTime, OffsetDateTime endTime, String subject) {
        super(Appointments.APPOINTMENTS);
