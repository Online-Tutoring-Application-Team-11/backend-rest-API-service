...
public class AvailableHoursDao extends DAOImpl<AvailableHoursRecord, onlinetutoring.com.teamelevenbackend.entity.tables.pojos.AvailableHours, Record2<Integer, String>> {
    ...
    @Override
    public Record2<Integer, String> getId(onlinetutoring.com.teamelevenbackend.entity.tables.pojos.AvailableHours object) {
        return compositeKeyRecord(object.getTutorId(), object.getDayOfWeek());
    }
